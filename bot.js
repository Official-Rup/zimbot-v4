...
//settings
global.owner = ['918617845264',''] //owner number +27634090203
global.wame = ['918617845264'] 
global.pemilik = ['918617845264'] //owner number +27634090203
global.premium = ['918617845264'] //premium number +27634090203
global.pengguna = '❥͜͡𝄟♥⃝Ⴤσυ†υвє|ᖇuρ࿐ཽ༵•❥͜͡★' //username
global.footer = '🐦ᴹᴿ᭄ RupOfcོ ×፝֟͜×💖'
global.botnma = '🐦ᴹᴿ᭄ Rup-BOTz-Ofcོ ×፝֟͜×💖' //bot name
global.botname = '🐦ᴹᴿ᭄ Rup-BOTz-Ofcོ ×፝֟͜×💖'
global.ownernma = '❥͜͡𝄟♥⃝Ⴤσυ†υвє|ᖇuρ࿐ཽ༵•❥͜͡★' //owner name
global.packname = '🐦ᴹᴿ᭄ Rup-BOTz-Ofcོ ×፝֟͜×💖' //sticker package name
global.author = 'By ❥͜͡𝄟♥⃝Ⴤσυ†υвє|ᖇuρ࿐ཽ༵•❥͜͡★' //sticker author name
...
global.mess = {
    ...
    botAdmin: '*🐦ᴹᴿ᭄ Rup-BOTz-Ofcོ ×፝֟͜×💖  must be admin first!*',
    owner: '*this feature is only for 🐦ᴹᴿ᭄ Rup-BOTz-Ofcོ ×፝֟͜×💖 owner*',
    group: '*Feature is only for groups!*',
    grouponly: '*Group Mode Only*',
    private: 'Features Used Only For Private Chat!',
    bot: 'This feature in only for the bot number',
    wait: '*whoa wait a moment 🐦ᴹᴿ᭄ Rup-BOTz-Ofcོ ×፝֟͜×💖 is proccessing*',
